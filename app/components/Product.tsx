...
export default function Product({ src, name, price }: ProductProps) {
  return (
    <section className='group relative flex items-center justify-center rounded-lg bg-gradient shadow-lg overflow-hidden p-1 cursor-pointer min-w-max'>
